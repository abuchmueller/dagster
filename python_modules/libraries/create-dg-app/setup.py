...
def get_version() -> str:
    ...
    with open(Path(__file__).parent / "create_dg_app/version.py", encoding="utf8") as fp:
...
setup(
    ...
    url=(
        "https://github.com/dagster-io/dagster/tree/master/python_modules/libraries/create-dg-app"
    ),
    classifiers=[
