...
from dagster.components.core.load_defs import get_all_components
...
def get_projects_from_dbt_component(components: Path) -> list[DbtProject]:
    return [component.project for component in get_all_components(components, DbtProjectComponent)]
